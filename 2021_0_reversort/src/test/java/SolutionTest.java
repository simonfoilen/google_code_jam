...
class SolutionTest {
    ...
    @Test
    void executeSample1_extra() throws Exception {
        executeSample("SolutionTest-executeSample1_extra-in.txt", "SolutionTest-executeSample1-out.txt");
    }
    ...
    @Test
    void executeOfficialTestSet1() throws Exception {
        executeSample("ts1_input.txt", "ts1_output.txt");
    }
